...
// global values
   ...
   // -------------------------------------------------
   // Wrapper function for graph calculation - handles trivial case
   // -------------------------------------------------
   ...
   jQuery(function () {
	...
	// -------------------------------------------------
	// Function to create all moving paths
	// -------------------------------------------------
	Raphael.el.animateSystem = function(pathE, pathS, pathG, duration, repetitions) {
	   ...
	   if(gelement.pathLen > 1000)gelement.pathLen = 300 + gr_del_save*2; // To fix firefox error in Ubuntu
	...
	// -------------------------------------------------
	// Wrap function to update all values, graphs and animations
	// -------------------------------------------------
	function updateALL(){
	...
	// *****************************************************************
		...
		// -----------------------------------------------
		// handle text input change for the planet radius
		// -----------------------------------------------
